      ...
      <div style={{
        ...
        <div style={{ display: 'flex', gap: '0.65rem', alignItems: 'center' }}>
          <span style={{
            ...
            <CheckCircleIcon size={14} color="#059669" /> Terverifikasi ISO 27001
          </span>
        </div>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(340px, 1fr))', gap: '1.75rem' }}>
        ...
        <div style={{ backgroundColor: '#ffffff', border: '1px solid var(--card-border)', borderRadius: '14px', padding: '1.75rem', boxShadow: '0 4px 20px rgba(0,0,0,0.03)' }}>
          <div style={{ borderBottom: '1px solid var(--card-border)', paddingBottom: '0.75rem', marginBottom: '1.25rem' }}>
            <h2 style={{ fontSize: '1.15rem', fontWeight: 800, color: 'var(--text-dark)', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              <BoxIcon size={20} color="var(--primary-green)" /> Form Setor Stok (Guided Grading)
            </h2>
          ...
          <form onSubmit={handleSetorStok} style={{ display: 'flex', flexDirection: 'column', gap: '1.1rem' }}>
            ...
            {formError && (
              <div style={{ fontSize: '0.82rem', color: 'var(--critical-red)', backgroundColor: 'var(--critical-red-light)', padding: '0.65rem 0.85rem', borderRadius: '8px', display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
                <AlertCircleIcon size={16} color="var(--critical-red)" /> {formError}
              </div>
            )}

            {formSuccessMessage && (
              <div style={{ fontSize: '0.82rem', color: '#047857', backgroundColor: '#ecfdf5', border: '1px solid #a7f3d0', padding: '0.65rem 0.85rem', borderRadius: '8px', display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
                <CheckCircleIcon size={16} color="#047857" /> {formSuccessMessage}
              </div>
            )}
