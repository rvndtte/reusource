...
import { BoxIcon, FactoryIcon, ShieldIcon, LogoutIcon } from './common/Icons';
      ...
      <header style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
            ...
            >
              <LogoutIcon size={14} color="#ef4444" /> Keluar
            </button>
          </div>
        </div>
      </header>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.85rem' }}>
            <div style={{
              ...
              <FactoryIcon size={22} color="#ffffff" />
            </div>
            <div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                <div style={{ fontWeight: 800, fontSize: '1.15rem', color: 'var(--text-dark)' }}>
      ...
      <header style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
            ...
            >
              <LogoutIcon size={14} color="#ffffff" /> Keluar Konsol
            </button>
          </div>
        </div>
      </header>
    ...
    <header style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
          <div style={{
            ...
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <path d="M11 19h8.2a1.8 1.8 0 0 0 1.57-.88 1.785 1.785 0 0 0 .004-1.784l-2.96-5.1" />
              <path d="M20 9l-4.5-8-4.5 8" />
              <polyline points="15 15 18 19 15 23" />
            </svg>
          </div>
          <div>
        ...
        <nav style={{
          ...
          <a href="#pemasok" onClick={(e) => { e.preventDefault(); if (onOpenSupplierModal) onOpenSupplierModal(); }} style={{ color: 'var(--text-muted)', textDecoration: 'none' }}>Untuk Pemasok</a>
          <a href="#pembeli" onClick={(e) => { e.preventDefault(); if (onOpenCatalogModal) onOpenCatalogModal(); }} style={{ color: 'var(--text-muted)', textDecoration: 'none' }}>Untuk Pembeli</a>
