  ...
  return (
    <section style={{
      ...
      <div style={{
        ...
        {/* Chat Bubble 1: Bengkel A (Compact) */}
        <div
        ...
        >
          <span>🪵 Bengkel A</span>
          <span style={{ color: '#cbd5e1', fontWeight: 600 }}>180 kg</span>
          <span style={{ color: '#34d399', fontSize: '8px' }} className="animate-pulse-ring">●</span>
          <div className="chat-bubble-tail-left" style={{ color: '#34d399' }} />
        </div>

        {/* Chat Bubble 2: Bengkel B (Compact) */}
        <div
        ...
        >
          <span>🪚 Bengkel B</span>
          <span style={{ color: '#cbd5e1', fontWeight: 600 }}>190 kg</span>
          <span style={{ color: '#f59e0b', fontSize: '8px' }} className="animate-pulse-ring">●</span>
          <div className="chat-bubble-tail-left" style={{ color: '#f59e0b' }} />
        </div>

        {/* Chat Bubble 3: Bengkel C (Compact) */}
        <div
          className="animate-float-bubble chat-bubble-container"
          style={{
            position: 'absolute',
        ...
        >
          <span>🪵 Bengkel C</span>
          <span style={{ color: '#cbd5e1', fontWeight: 600 }}>150 kg</span>
          <span style={{ color: '#34d399', fontSize: '8px' }} className="animate-pulse-ring">●</span>
          <div className="chat-bubble-tail-left" style={{ color: '#34d399' }} />
        </div>

        {/* Chat Bubble 4: Bengkel D (Compact) */}
        <div
          className="animate-float-bubble-alt chat-bubble-container"
          style={{
            position: 'absolute',
        ...
        >
          <span>🪚 Bengkel D</span>
          <span style={{ color: '#cbd5e1', fontWeight: 600 }}>200 kg</span>
          <span style={{ color: '#34d399', fontSize: '8px' }} className="animate-pulse-ring">●</span>
          <div className="chat-bubble-tail-left" style={{ color: '#34d399' }} />
        </div>

        {/* Auto Agregasi Card (Compact & Shifted to avoid CTA button overlap) */}
        <div
          style={{
            position: 'absolute',
            top: '415px',
        ...
        >
          <span style={{ fontSize: '0.58rem', fontWeight: 800, color: '#059669', letterSpacing: '0.04em', display: 'block' }}>
            AUTO AGREGASI
          </span>
          <span style={{ fontSize: '0.58rem', color: '#64748b', fontWeight: 600, display: 'block' }}>
            Berdasarkan Radius
          </span>
          <span className="tabular-nums" style={{ fontSize: '1.05rem', fontWeight: 800, color: '#059669', display: 'block', margin: '1px 0' }}>
            1.520 kg
          </span>
          <span style={{ fontSize: '0.58rem', fontWeight: 800, color: '#059669', backgroundColor: '#ecfdf5', padding: '1px 6px', borderRadius: '6px', display: 'inline-block' }}>
            ✓ SIAP JEMPUT
          </span>
        </div>

        {/* Chat Bubble 6: MILK-RUN ROUTE (Shifted to the left) */}
        <div
          className="animate-float-bubble-alt chat-bubble-container"
          style={{
            position: 'absolute',
        ...
        >
          ...
          <div>
            <span style={{ fontSize: '0.6rem', fontWeight: 800, color: '#34d399', letterSpacing: '0.05em', display: 'block' }}>
              MILK-RUN ROUTE
            </span>
            <span style={{ fontSize: '0.65rem', fontWeight: 600, color: '#e2e8f0' }}>
        ...
        {/* Pabrik Briket Malang Card (Compact Callout Label) */}
        <div
          className="animate-float-bubble chat-bubble-container"
          style={{
            position: 'absolute',
        ...
        >
          <h5 style={{ fontSize: '0.68rem', fontWeight: 800, color: '#ffffff', margin: 0 }}>
            Pabrik Briket Malang
          </h5>
          <span className="tabular-nums" style={{ fontSize: '0.88rem', fontWeight: 800, color: '#60a5fa', display: 'block', margin: '1px 0' }}>
            1.500 kg / Hari
          </span>
          <span style={{ fontSize: '0.55rem', fontWeight: 800, color: '#34d399', backgroundColor: 'rgba(52, 211, 153, 0.2)', padding: '1px 6px', borderRadius: '5px', display: 'inline-block' }}>
            ✓ AUTO MATCHED
          </span>
